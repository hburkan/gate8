...
export interface EntityAdapter {
   ...
   * `'evidence'`, the Phase 21 `EvidenceForm` — instead of the generic
   * `EntityForm` (same server actions and validation; presentation only).
   */
  editor?: 'character' | 'item' | 'document' | 'evidence';
}
